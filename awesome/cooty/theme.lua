...
theme.taglist_bg_focus = "#364b44"
theme.taglist_bg_empty = "#001408"
theme.taglist_bg_normal = "#566977"

theme.taglist_fg_focus = "#8d7c6c"
...
theme.wallpaper = themes_path.."/cooty/background"
